...
function Header ({ setView }) {
  return (
    <React.Fragment>
      <header className="flex justify-around py-6 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-[#8DD3D1] rounded-[40%/10%] ring-4 ring-blue-500 mx-8 my-4 drop-shadow-2xl  shadow-inner-2xl mix-blend-darken">
